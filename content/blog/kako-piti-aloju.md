          ...
          <div class="flex items-center text-sm">
           ...
           <div class="flex items-center text-sm">
			...
			<div class="flex gap-md@sm gap-md flex-column flex-row@sm padding-top-lg justify-between@sm items-center">
				<g-link to="/napici/aloe-berry/" class="kupiteCTA btn btn--primary flex-grow center-between@lg justify-center btn--md">
					Saznajte više
				</g-link>
        ...
        <div class="grid margin-bottom-lg gap-xxs">
          ...
          <div class="flex items-center text-sm">
           ...
           <div class="flex items-center text-sm">
			...
			<div class="flex gap-md@sm gap-md flex-column flex-row@sm padding-top-lg justify-between@sm items-center">
				<g-link to="/preparati-za-negu-koze/aloe-first/" class="kupiteCTA btn btn--primary flex-grow center-between@lg justify-center btn--md">
					Saznajte više
				</g-link>
				<g-image style="width: auto !important;" class="" src="~/assets/img/logo-futer.png"></g-image>
			</div>
        ...
        <div class="grid margin-bottom-lg gap-xxs">
          ...
          <div class="flex items-center text-sm">
           ...
           <div class="flex items-center text-sm">
			...
			<div class="flex gap-md@sm gap-md flex-column flex-row@sm padding-top-lg justify-between@sm items-center">
				<g-link to="/preparati-za-negu-koze/hidratantni-losion/" class="kupiteCTA btn btn--primary flex-grow center-between@lg justify-center btn--md">
					Saznajte više
				</g-link>
				<g-image style="width: auto !important;" class="" src="~/assets/img/logo-futer.png"></g-image>
			</div>
