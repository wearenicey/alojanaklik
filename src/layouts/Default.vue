<template>
  <div>
    <header class="f-header js-f-header position-relative bg-white">
      ...
      <div class="f-header__nav" role="navigation">
        ...
        >
          ...
          <ul class="f-header__list flex-grow flex-basis-0 justify-center@md">
            ...
            <li class="f-header__item">
              <g-link to="/contact/" class="f-header__btn btn btn--primary"
                >Kontakt</g-link
              >
            </li>
          </ul>
      ...
      <div class="container max-width-lg">
        <nav class="footer-v4__nav">
          <ul class="footer-v4__nav-list">
            ...
            <li class="footer-v4__nav-item">
              <g-link to="/nega-lica-i-tela/"> Nega lica i tela </g-link>
            </li>
            <li class="footer-v4__nav-item">
              <g-link to="/licna-higijena/"> Lična higijena </g-link>
            </li>
            <li class="footer-v4__nav-item">
            ...
            <li class="footer-v4__nav-item">
              <g-link to="/contact/" class="btn btn--primary">Kontakt</g-link>
            </li>
          </ul>
        </nav>
        ...
        <p class="footer-v4__print">FOREVER POSLOVNI SARADNIK</p>
