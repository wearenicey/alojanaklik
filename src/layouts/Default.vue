					...
					<ul class="f-header__list flex-grow flex-basis-0 justify-center@md">
						<li class="f-header__item">
							...
							<ul class="f-header__dropdown">
								...
								<li><a href="#0" class="f-header__dropdown-link">Sub Nav Item Three Item Three</a></li>
		...
		<footer class="footer-v4 padding-y-lg">
			<div class="container max-width-lg">
				...
				<div class="footer-v4__logo">
					<a @click="x">
						<g-image src="~/assets/img/foreverlogogold.png" alt="Forever Living Gold"></g-image>
					</a>
				</div>
