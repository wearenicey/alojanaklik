<template>
	<Layout>
		...
		<div class="typeform-widget" data-url="https://form.typeform.com/to/GZe1EmtO?typeform-medium=embed-snippet" style="width: 100%; height: 500px"></div>
				...
				<ul class="accordion js-accordion" data-animation="on" data-multi-items="on">
					<li class="accordion__item js-accordion__item">
						<button class="reset accordion__header padding-y-sm padding-x-md js-tab-focus" type="button">
							<span class="text-md">How can I download the invoice for my purchase?</span>
						...
						<div class="accordion__panel js-accordion__panel">
							<div class="text-component padding-top-xxxs padding-x-md padding-bottom-md">
								<p>
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum a ab quae quas optio ut officia quia? Modi at impedit dolorem est voluptatem facilis, beatae atque tenetur, soluta dolorum inventore sapiente laborum. Alias
					...
					<li class="accordion__item js-accordion__item">
						<button class="reset accordion__header padding-y-sm padding-x-md js-tab-focus" type="button">
							<span class="text-md">How many devices can I use?</span>
					...
					<li class="accordion__item js-accordion__item">
						<button class="reset accordion__header padding-y-sm padding-x-md js-tab-focus" type="button">
							<span class="text-md">What is the license of your resources?</span>
					...
					<li class="accordion__item js-accordion__item">
						<button class="reset accordion__header padding-y-sm padding-x-md js-tab-focus" type="button">
							<span class="text-md">Can I suggest new app features?</span>
				...
				<div class="margin-bottom-lg">
					<dl class="details-list details-list--rows grid details-list--cols@md">
						<div class="details-list__item padding-y-md padding-x-md@md text-center@md col-4@md">
							<dt class="font-bold margin-bottom-xxs">Drustvene mreze</dt>
						...
						<div class="details-list__item padding-y-md padding-x-md@md text-center@md col-4@md">
							...
							<dd class="line-height-md">
								...
								<p class="color-contrast-medium">Mon - Fri, 9AM - 5PM</p>
							</dd>
						</div>
					</dl>
				</div>
