      ...
      <div class="container max-width-sm margin-y-xl">
        ...
        >
          <li class="accordion__item js-accordion__item">
            ...
            >
              <span class="text-md"
                >How can I download the invoice for my purchase?</span
              >

              <svg
                class="icon accordion__icon-arrow-v2 no-js:is-hidden"
                viewBox="0 0 16 16"
                aria-hidden="true"
              >
                <g
            ...
            <div class="accordion__panel js-accordion__panel">
              ...
              >
                <p>
                  ...
                  Nostrum a ab quae quas optio ut officia quia? Modi at impedit
                  dolorem est voluptatem facilis, beatae atque tenetur, soluta
                  dolorum inventore sapiente laborum. Alias esse soluta porro
                  distinctio aperiam, qui suscipit.
                </p>
              </div>
            </div>
          </li>
          ...
          <li class="accordion__item js-accordion__item">
            ...
            >
              <span class="text-md"
                >What is the license of your resources?</span
              >
      ...
      <div class="container max-width-xs margin-bottom-lg">
        <div class="text-component text-center">
          ...
          <p>
            ...
            eos impedit nesciunt voluptates magni vero itaque.
          </p>
        </div>
      </div>
