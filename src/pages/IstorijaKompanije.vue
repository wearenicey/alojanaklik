		...
		<section class="position-relative z-index-2 bg shadow-sm">
			...
			<div class="container max-width-sm min-height-100vh flex flex-center">
				<div class="text-component text-center">
					...
					<p>Forever Living Products je osnovan na ideji da promeni živote ljudi širom sveta, distribucijom kvalitetnih zdravstvenih rešenja na bazi aloja vere.</p>
				</div>
			</div>
		</section>
			...
			<div class="container max-width-adaptive-lg">
				<div class="v-timeline js-v-timeline" data-animation="on">
					<section class="v-timeline__section js-v-timeline__section">
						<div class="v-timeline__marker bg-contrast-high border border-3 border-contrast-lower" aria-hidden="true"></div>
							...
							<div class="v-timeline__item bg padding-md radius-md shadow-xs">
								<div class="text-component">
									<p>
										...
										<span class="text-bold"> „Zašto provesti život radeći na izgradnji tuđeg sna? Zašto ne biste izgradili svoj?“</span>
									</p>
								</div>
							</div>
							<div class="v-timeline__item bg padding-md radius-md shadow-xs">
								<div class="text-component">
									<p>Od tada, Forever Living Products se zalaže za traženje najboljih prirodnih sastojaka za dobrobit i deljenje sa drugima iz svih krajeva zemlje koji žele da se osećaju bolje kroz izbor zdravog života.</p>
								</div>
							</div>
						</div>
					</section>
...
export default {
	...
	mounted() {
		...
		let revealingSection = document.createElement("script");
		revealingSection.setAttribute("src", "../revealing-section.js");
		revealingSection.setAttribute("id", "revealing-section-js");
		document.body.appendChild(revealingSection);
	...
	destroyed() {
		...
		document.getElementById("revealing-section-js").remove();
