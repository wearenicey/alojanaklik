		...
		<section class="bg-secondary">
			<div class="container max-width-adaptive-lg padding-bottom-xxl">
				<div class="grid gap-md">
					<a class="card-v11 col-3@md radius-lg" href="/dodaci-ishrani/forever-daily/" style="background-image: url(../forever-daily.jpg)" aria-label="Link description">
					...
					<a class="card-v11 col-3@md radius-lg display@md" href="/dodaci-ishrani/forever-fokus-aloja/" style="background-image: url(../forever-fokus.jpg)" aria-label="Link description">
						<div class="card-v11__box width-90% border border-2 border-contrast-low border-opacity-50% radius-lg">
							<div class="padding-sm text-center text-md">
					...
					<a class="card-v11 col-3@md radius-lg display@md" href="/dodaci-ishrani/supergreens/" style="background-image: url(../supergreens.jpg)" aria-label="Link description">
						<div class="card-v11__box width-90% border border-2 border-contrast-low border-opacity-50% radius-lg">
							<div class="padding-sm text-center text-md">
